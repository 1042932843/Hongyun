...
import com.dyhl.hongyun.dangjian.adapter.NewslistAdaptent;
import com.dyhl.hongyun.dangjian.model.ApiMsg;
import com.dyhl.hongyun.dangjian.model.Newslist;
import com.dyhl.hongyun.dangjian.model.User;
import com.dyhl.hongyun.dangjian.ui.OnScrollLastItemListener;
import com.dyhl.hongyun.dangjian.ui.OnScrollListener;
import com.dyhl.hongyun.dangjian.util.HttpUtil;
import com.dyhl.hongyun.dangjian.view.PullToRefreshLayout;
import com.dyhl.hongyun.dangjian.view.SwipeMenu;
import com.dyhl.hongyun.dangjian.view.SwipeMenuCreator;
import com.dyhl.hongyun.dangjian.view.SwipeMenuItem;
import com.dyhl.hongyun.dangjian.view.SwipeMenuListView;
    ...
    private class NoticeApi extends HttpUtil {
        ...
        public void Notice(String uuid) {
            ...
            send(HttpRequest.HttpMethod.POST,
                    "phoneNewsController.do?userNewsListPage",
                    "uuid", uuid,
                    "currentPage", page + ""
...
//                        RedFlag redFlag = JSON.parseObject(o, RedFlag.class);
    ...
    private class DeleteApi extends HttpUtil {
        ...
        public void delete(String userId, String nurseId) {
            ...
            send(HttpRequest.HttpMethod.POST,
                    "phoneNewsController.do?deleteNewsByUser",
                    "uuid", userId,
                    "newsId", nurseId
