...
import com.dyhl.hongyun.dangjian.adapter.PartyBranchAdapter;
import com.dyhl.hongyun.dangjian.model.ApiMsg;
import com.dyhl.hongyun.dangjian.model.PartyBranch;
    ...
    private class PartyBranchApi extends HttpUtil {
        ...
        public void PartyBranch() {
            ...
            send(HttpRequest.HttpMethod.POST,
                    "phoneNewsController.do?areaTreeType" // 党员
            );
        }
        ...
        public void Partyrepresentative(String areaId) {
            ...
            send(HttpRequest.HttpMethod.POST,
                    "phoneNewsController.do?ddbUserList", // 党员
                    "areaId", areaId
            );
        }
