...
import com.dyhl.hongyun.dangjian.Service.WebSocketService;
import com.dyhl.hongyun.dangjian.adapter.FragmentPagerAdapter;

import com.dyhl.hongyun.dangjian.fragments.HomeFragment;
import com.dyhl.hongyun.dangjian.fragments.LoginFragment;
import com.dyhl.hongyun.dangjian.fragments.PagerFragment;
import com.dyhl.hongyun.dangjian.fragments.PartyFragment;
import com.dyhl.hongyun.dangjian.fragments.SpeakFragment;
import com.dyhl.hongyun.dangjian.fragments.UserFragment;
import com.dyhl.hongyun.dangjian.listener.PgyUpdateManagerListener;
import com.dyhl.hongyun.dangjian.listener.SystemBarTintManager;
import com.dyhl.hongyun.dangjian.model.GlobalValue;
import com.dyhl.hongyun.dangjian.model.User;
import com.dyhl.hongyun.dangjian.util.LogUtil;
import com.dyhl.hongyun.dangjian.view.FragmentViewPager;
...
//        phone = (ImageButton)findViewById(R.id.phone);
    ...
    private void initViews() {
        View[] views = {travel, hui_pu_jin_rong, djcyltv, pests, flood_information, notice_of_program, social_service, huimin_subsidies, sjd};
        ...
        if (user != null) {
            pagerAdapter = new FragmentPagerAdapter(
                    fragmentManager,
                    HomeFragment.class, // 资讯
                    PartyFragment.class, // 消息
                    SpeakFragment.class, // 应用
