...
import com.dyhl.hongyun.dangjian.activity.AboutUsActivity;
import com.dyhl.hongyun.dangjian.activity.CollectionActivity;
import com.dyhl.hongyun.dangjian.activity.IntercalateActivity;
import com.dyhl.hongyun.dangjian.activity.LoginActivity;
import com.dyhl.hongyun.dangjian.activity.MyfilesActivity;
import com.dyhl.hongyun.dangjian.activity.NewslistActivity;
import com.dyhl.hongyun.dangjian.activity.NoticeActivity;
    ...
    private class UserApi extends HttpUtil {
        ...
        public void User(String uuid) {
            ...
            send(HttpRequest.HttpMethod.POST,
                    "phoneUserOnlineController.do?loginUserInfo", // 登录接口地址
                    "uuid", uuid
