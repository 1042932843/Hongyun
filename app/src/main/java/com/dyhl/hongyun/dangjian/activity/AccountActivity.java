...
import com.dyhl.hongyun.dangjian.adapter.Accountdapter;
import com.dyhl.hongyun.dangjian.model.Account;
import com.dyhl.hongyun.dangjian.model.ApiMsg;
import com.dyhl.hongyun.dangjian.util.HttpUtil;
import com.dyhl.hongyun.dangjian.view.ListViewForScrollView;
    ...
    private class AccountApi extends HttpUtil {
        ...
        public void Account(String areaId) {
            ...
            send(HttpRequest.HttpMethod.POST,
                    "phoneNewsController.do?dysjtzByArea",
                    "areaId", areaId
