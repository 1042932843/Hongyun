...
import com.dyhl.hongyun.dangjian.permission.PermissionsActivity;
import com.dyhl.hongyun.dangjian.permission.PermissionsChecker;
import com.dyhl.hongyun.dangjian.util.Constant;
import com.dyhl.hongyun.dangjian.util.HttpUtil;
import com.dyhl.hongyun.dangjian.util.Util;
import com.dyhl.hongyun.dangjian.view.CustomWebView;
import com.dyhl.hongyun.dangjian.view.PullToRefreshLayout;
import com.dyhl.hongyun.dangjian.view.UEasyPlayer;
...
//        share_btn9.setOnClickListener(share);
    ...
    public void shareWeb(int Target){
        ...
        webpage.webpageUrl = Constant.DOMAIN+"/webpage/wxNewsDetail.html?id="+id;
    ...
    public void wechat(String name) {
        ...
        /*if (!WXPayEntryActivity.isWXAppInstalled(App.me())) {
            ...
            try {
                ...
                sp.setUrl("http://218.29.203.38:8096/webpage/wxNewsDetail.html?id="+id);
                // titleUrl是标题的网络链接，仅在人人网和QQ空间使用
                sp.setTitleUrl("http://218.29.203.38:8096/webpage/wxNewsDetail.html?id="+id);
                // comment是我对这条分享的评论，仅在人人网和QQ空间使用
                sp.setComment(title.getText().toString());//分享文本
                // site是分享此内容的网站名称，仅在QQ空间使用
                sp.setSite(getString(R.string.app_name));
                // siteUrl是分享此内容的网站地址，仅在QQ空间使用
                sp.setSiteUrl("http://218.29.203.38:8096/webpage/wxNewsDetail.html?id="+id);
...
//                        complain.setText("收藏");
        ...
        public void Newsdetail(String uuid, String newsId) {
            ...
            if (null != uuid) {
                send(HttpRequest.HttpMethod.POST,
                        "phoneNewsController.do?newsDetails",
                        "uuid", uuid,
                        "newsId", newsId
                );
            } else {
    ...
    private class ComplainApi extends HttpUtil {
        ...
        public void Complain(String newsId, String uuid) {
            ...
            send(HttpRequest.HttpMethod.POST,
                    "phoneNewsController.do?addCollection",
                    "newsId", newsId,
                    "uuid", uuid,
                    "type", "1"
...
//                String resultInfo = apiMsg.getResult();
    ...
    private class CancelApi extends HttpUtil {
        ...
        public void Cancel(String uuid, String newsId) {
            ...
            send(HttpRequest.HttpMethod.POST,
                    "phoneNewsController.do?cancelCollection",
                    "uuid", uuid,
                    "newsId", newsId,
                    "type", "1"
