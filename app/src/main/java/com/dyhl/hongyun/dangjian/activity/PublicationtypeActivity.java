...
import com.dyhl.hongyun.dangjian.adapter.PublicationtypeAdapter;
import com.dyhl.hongyun.dangjian.model.ApiMsg;
import com.dyhl.hongyun.dangjian.model.PublicationType;
    ...
    private class PublicationtypeApi extends HttpUtil {
        ...
        public void Publicationtype(String uuid) {
            ...
            send(HttpRequest.HttpMethod.POST,
                    "phoneNewsController.do?newsTypeList",
                    "uuid", uuid
            );
        }
        @Override
